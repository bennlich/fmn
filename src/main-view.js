<bob-view>
  ...
  // our datastore
  var itemsReference = new Firebase("https://bennlich.firebaseio.com/fmn/items");
  ...
  itemsReference.on("value", function(snap) {
    this.items = snap.val();
  ...
  remove(event) {
    ...
    itemsReference.child(item.key).remove();
  }
